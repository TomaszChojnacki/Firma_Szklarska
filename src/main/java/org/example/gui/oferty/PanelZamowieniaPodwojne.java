...
public class PanelZamowieniaPodwojne extends JPanel {
    ...
    public PanelZamowieniaPodwojne() {
        ...
        ImageIcon icon = new ImageIcon(getClass().getClassLoader().getResource("oferty/podwojne.png"));
        ...
        JLabel naglowek = new JLabel("Podwójne szkło energooszczędne");
        ...
        JLabel opis = new JLabel("<html><small>Izolacyjne szkło zapewniające lepszą efektywność energetyczną.</small></html>");
        ...
        gbc.gridy = y++;
        chkMaterialy = new JCheckBox("Materiały szklarskie (190,00 zł)");
        ...
        btnDodaj.addActionListener(e -> {
            ...
            String opisZamowienia = "Podwójne szkło energooszczędne - Rozmiar: " + szer + "x" + wys + " mm, "
