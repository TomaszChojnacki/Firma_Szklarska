...
public class PanelZamowieniaPojedyncze extends JPanel {
    ...
    public PanelZamowieniaPojedyncze() {
        setLayout(new BorderLayout());
        setBackground(Color.WHITE);

        // Lewy panel z obrazem
        JLabel obrazek = new JLabel();
        obrazek.setHorizontalAlignment(JLabel.CENTER);
        ImageIcon icon = new ImageIcon(getClass().getClassLoader().getResource("oferty/pojedyncze.png"));
        ...
        JLabel naglowek = new JLabel("Pojedyncza szyba standardowa");
        ...
        JLabel opis = new JLabel("<html><small>Grubość szkła automatycznie dostosowuje się do rozmiaru zgodnie z normami.</small></html>");
        ...
        gbc.gridx = 1;
        comboInstalacja = new JComboBox<>(new String[]{"Nie (0,00 zł)", "Tak (450,00 zł)"});
        ...
        gbc.gridx = 1;
        comboKratka = new JComboBox<>(new String[]{"Nie (0,00 zł)", "Tak (90,00 zł)"});
        ...
        // Koraliki
        gbc.gridx = 0; gbc.gridy = y++; gbc.gridwidth = 2;
        chkKoraliki = new JCheckBox("Koraliki szkliniące (100,80 zł)");
        chkKoraliki.setBackground(Color.WHITE);
        panelForm.add(chkKoraliki, gbc);

        // Materiały szklarskie
        gbc.gridy = y++;
        chkMaterialy = new JCheckBox("Materiały szklarskie (150,0 zł)");
        ...
        btnDodaj.addActionListener(e -> {
            ...
            String opisZamowienia = "Szkło pojedyńcze - Rozmiar: " + szer + "x" + wys + " mm, "
            ...
            org.example.gui.koszyk.PanelKoszyka.dodajProdukt("Pojedyncza szyba", opisZamowienia, aktualnaCena);
