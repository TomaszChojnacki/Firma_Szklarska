...
public class PanelZamowieniaPotrojne extends JPanel {
    ...
    public PanelZamowieniaPotrojne() {
        setLayout(new BorderLayout());
        setBackground(Color.WHITE);

        //Obrazek lewej strony
        JLabel obrazek = new JLabel();
        obrazek.setHorizontalAlignment(JLabel.CENTER);
        ImageIcon icon = new ImageIcon(getClass().getClassLoader().getResource("oferty/potrojne.png"));
        ...
        JLabel naglowek = new JLabel("Potrójna szyba premium");
        ...
        JLabel opis = new JLabel("<html><small>Najlepsza izolacja cieplna i akustyczna, spełnia najwyższe normy.</small></html>");
        ...
        gbc.gridx = 1;
        comboInstalacja = new JComboBox<>(new String[]{"Nie (0,00 zł)", "Tak (600,00 zł)"});
        ...
        gbc.gridx = 1;
        comboKratka = new JComboBox<>(new String[]{"Nie (0,00 zł)", "Tak (100,00 zł)"});
        ...
        // Koraliki
        gbc.gridx = 0; gbc.gridy = y++; gbc.gridwidth = 2;
        chkKoraliki = new JCheckBox("Koraliki szkliniące (120,00 zł)");
        chkKoraliki.setBackground(Color.WHITE);
        panelForm.add(chkKoraliki, gbc);

        // Materiały szklarskie
        gbc.gridy = y++;
        chkMaterialy = new JCheckBox("Materiały szklarskie (200,00 zł)");
        ...
        btnDodaj.addActionListener(e -> {
            ...
            String opisZamowienia = "Potrójna szyba premium - Rozmiar: " + szer + "x" + wys + " mm, "
            ...
            org.example.gui.koszyk.PanelKoszyka.dodajProdukt("Potrójna szyba premium", opisZamowienia, aktualnaCena);
